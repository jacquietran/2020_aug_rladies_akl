...
Within the Rmd, source the script from within a code chunk:
...
## Build reports on a set schedule (e.g., daily, weekly, monthly)
...
Render an R Markdown report to **HTML**, **PDF**, and **Word** outputs

--

**HTML outputs** are particularly powerful. Turn an R Markdown file into:

- A slidedeck like this one using `{xaringan}`
- An interactive dashboard using packages like `{flexdashboard}`
...
### Looking for this slidedeck?

[jacquietran.github.io/2020_aug_rladies_akl/](https://jacquietran.github.io/2020_aug_rladies_akl)
